module.exports = {
  ...
  text: './studies/1thessalonians/texts/STUDY_8.txt',
  observe: {
    people: ['Timothy', 'us = Paul, Silvanus', 'you = Thessalonians', 'your = Thessalonians', 'brothers', 'we = Paul, Silvanus', 'Lord', 'God', 'our', 'Father', 'Lord Jesus', 'one another', 'for all', 'he = the Lord', 'all his saints'],
    nouns: ['news', 'faith', 'love', 'reason', 'distress', 'affliction', 'thanksgiving', 'joy', 'your sake', 'night', 'day', 'face', 'what is lacking', 'way', 'hearts', 'holiness', 'the coming'],
    adjectives: ['good', 'always', 'kindly', 'fast', 'before', 'earnestly', 'lacking', 'blameless', 'all'],
    actions: ['come', 'brought', 'reported', 'remember', 'long to see', 'comforted', 'live', 'standing fast', 'return', 'feel', 'pray', 'see', 'supply', 'direct', 'increase', 'abound', 'establish', 'coming'],
    persons: {
      God: [
