module.exports = {
  ...
  text: './studies/1thessalonians/texts/STUDY_9.txt',
  observe: {
    people: ['brothers = Thessalonians', 'we = Paul,Silvanus,Timothy', 'you = Thessalonians', 'Lord Jesus', 'us = Paul,Silvanus,Timothy', 'God', 'your', 'his', 'Gentiles', 'brother', 'the Lord', 'whoever', 'Holy Spirit'],
    nouns: ['instructions', 'will', 'sanctification', 'sexual imorality', 'body', 'holiness', 'honor', 'passion of lust', 'this matter', 'avenger', 'things', 'impurity', 'holiness', 'man'],
    adjectives: ['Finally', 'in', 'more and more', 'through', 'sexual', 'own', 'all', 'solemnly'],
    actions: ['ask', 'urge', 'received', 'walk', 'please', 'doing', 'do', 'know', 'gave', 'abstain', 'control', 'transgress', 'wrong', 'told', 'warned', 'called', 'disregards', 'gives'],
    persons: {
      God: [
  ...
  interpret: {
    mainPoint: `Paul urged the Thessalonians to continue growing in the Lord, and to do so specifically in the area of sexual holiness`,
    keywords: {
    ...
    expound: [
      ...
      {
        one: `know how to control his own body`,
        two: `Not by force, not in silly self-manipulation, but in holiness and honor will my body be controlled`,
        three: `There is no physical training strenuous enough- no sage word sufficiently penetrating to tame the wild and wayward instincts of my flesh and blood. Holiness, that otherworldly wholeness, that honor unattainable here- this can render my limbs to obey the original design to which I am reconciled by my King and Commander, Jesus Christ.`,
        four: `There are many forms in which man labors in the pursuit of self-excellence. There are many devices man employs to exert order over his affairs. But holiness cannot be conjured from within. Holiness be that position which is assigned from on high, that condition which can only be provided by the One who occupies it from everlasting to everlasting.`
      }
    ]
  },
  application: {
    conversation: [
      { question: `What are some ways that you have grown as a person since you have belonged to God? What would it sound like to express this back to God in the form of thanks to Him? In what ways do you see that He is calling you to continue to grow in Him?` },
      { question: `What instructions have you received through the Lord Jesus? Think of different people or place you might receive instructions: a school teacher, the sign at a swimming pool, driving laws, from a spouse or parent. How does your attitude and enthusiasm about these rules change based on where they are coming from? If someone that you love, and you know loves you, told you they wanted you to do something how would you respond? Jesus is your Good King, He is your commander, your friend and your brother. He loves you and is perfect in His intentions toward you. Remember again, what are His instructions to you, and how do you receive them?` }
    ],
    ACTS: {
      adoration: [],
      confession: [],
